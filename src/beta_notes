...
05b0099: pre-pended in/out dirs, and all outputs are now in outputs/. Name changes: 
...
f69ca44: updated nc libs in GOTM3 make;
---------------------------------------------------------------
Changes in param.in and main parameter inputs for other modules:
R5217: repalced bottom friction coefficient output with bottom stress vector output;
...
(80) R4831: removed w_s* in btrack in vortex forrce
