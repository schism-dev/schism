...
!**********************************************************************
      ...
      ISTAT = NF90_GET_VAR(NCID,STAT_LON_ID,XP_WW3,start=(/1/),count = (/NP_WW3/))
      ...
      ISTAT = NF90_GET_VAR(NCID,STAT_LAT_ID,YP_WW3,start=(/1/),count = (/NP_WW3/))
      ...
      !------------------------------------
      ! Converting direction from WW3 convention to WWM convention
      ! In WW3, the direction stored is the one towards which waves are propagating (TO), increasing counter-clockwise, with the origin taken towards the East.
      DR_WW3 = MOD(PI2-DR_WW3,PI2)
