...
!  ifort -cpp -O2 -assume byterecl -o combine_output10.exe ../UtilLib/argparse.f90 ../UtilLib/schism_geometry.f90 combine_output10.f90 -I$NETCDF/include -I$NETCDF_FORTRAN/include -L$NETCDF_FORTRAN/lib -L$NETCDF/lib -lnetcdf -lnetcdff
