 ...
 */
#ifndef lint
static char RCSid[] = "$Id: draw.c,v 1.3 2007/02/21 00:21:21 pturner Exp $";
#endif
...
void device2view(int x, int y, double *vx, double *vy), view2world(double vx, double vy, double *x, double *y);
...
void setmapscale(double mapscale, double xv1, double yv1, double xv2, double yv2, double *xg1, double *yg1, double *xg2, double *yg2)
{
    double dx, dy, dxv, dyv, dxi, dyi, scalex, scaley;
...
void rectstr(double x1, double y1, double x2, double y2, int px, int py)
{
    char buf[28];
 ...
 */
void drawgridlines(int dir, double start, double end, double y1, double y2, double step, int cy, int ly, int wy)
{
    int slin, swid, scol;
...
void symfish1(int x, int y, double s, int f)
{
    int cs;
    int side = (int) devsymsize * s;
...
void symfish2(int x, int y, double s, int f)
{
    int cs;
    int side = (int) devsymsize * s;
...
void velplt(double xx, double yy, double u, double v, double vscale)
{
 ...
 * tidal ellipses
 */
void vellineplt(double xx, double yy, double u1, double v1, double u2, double v2, double vscale)
{
    double x, y;
    int ix, iy;
    int ix1, iy1;
...
void fluxplt(double xx, double yy, double u, double v, double vscale)
{
    double x, y, s, xl, yl, xr, yr, adj;
    double theta, i1, i2;
    int ix1, iy1;
 ...
 */
void putlegend(int i, int d, int xlen, int ylen, double size, double x, double y, int sy, int ly, int cy, int wy, char *s, int barflag, int fill, int fu, int fc, int fp)
{
 ...
 * draw the legend at world coordinates (x,y)
 */
void putpatlegend(int i, int xlen, int ylen, int xgap, int ygap, double size, double x, double y, double val, int pat, int ly, int cy, int ib, int prec, int labtype, char *lab)
{
...
void set_colormapdata(int i, int rr, int gg, int bb)
{
    switch (devtype) {
    case 0:
...
void set_colormap(int cm, int i, int rr, int gg, int bb)
{
    switch (cm) {
    case 0:
	break;
...
void putelevmarker(double x, double y, double ex, double ey, double emin, double emax, double e)
{
...
void set_video(int vflag)
{
    do_video = vflag;
}

void drawclock(double x, double y, double tott, double t, int clock_color, int clock_fillcolor)
{
...
void drawmapscale(double mapx, double mapy, double maplen, char *buf)
{
    double wx, wy;
    int x1, y1, x2, y2;
    int ifx = stringextentx(devcharsize, "M");
...
void drawvellegend(double velx, double vely, double vellenu, double vellenv, double vscale, char *buf)
{
    int ify = stringextenty(devcharsize, "M");
...
void drawfluxlegend(double velx, double vely, double vellenu, double vellenv, double vscale, char *buf)
{
    int ifx = stringextentx(devcharsize, "M");
...
void drawisollegend(double legx, double legy, double *cis, int n, int vgap, int hgap, int form, int prec, int lcol, int *cmap, int nmap, int vid)
{
    char buf[50];
    int i, j;
    int ifx = stringextentx(devcharsize, "M");
...
void drawisollegendh(double legx, double legy, double *cis, int n, int vgap, int hgap, int form, int prec, int lcol, int *cmap, int nmap, int vid)
{
    char buf[50];
    int i, j;
    int ifx = stringextentx(devcharsize, "M");
...
double convt(double t, int units)
{
    double retval;
    switch (units) {
    case 0:
...
char *format_time(double t, int units)
{
    static char buf[256];
    switch (units) {
    case 0:
...
void timeline(double t, double start, double end, double tdiv, int units, int prec, double locx, double locy, int len, int layout, int c1, int c2, int c3)
{
    char buf[100];
