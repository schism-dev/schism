...
hg = read_hgrid('/sciclone/schism10/Hgrid_projects/STOFS3D-v8/v52/Improve/hgrid.ll')
hg.compute_bnd()
...
with open('/sciclone/schism10/Hgrid_projects/STOFS3D-v8/v52/Improve/isolated_parts.txt', 'w') as f:
    f.write('lon lat\n')
