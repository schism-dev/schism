"""Legacy ``.reg`` and value-only GeoPackage regional tweak workflows.

This module is frozen for older bathy-edit tasks. New code should import the
strict GeoPackage implementation from ``regional_tweaks`` instead.
"""
