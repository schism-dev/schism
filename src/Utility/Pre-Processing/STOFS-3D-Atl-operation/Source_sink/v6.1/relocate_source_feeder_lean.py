...
def relocate_sources(old_source_sink_in:SourceSinkIn, old_vsource:np.ndarray, times: np.array, outdir=None, relocate_map = None):
    ...
    #df_subset.to_csv(f'{outdir}/vsource.th', index=False, header=False, sep=' ', float_format='%.5f')
