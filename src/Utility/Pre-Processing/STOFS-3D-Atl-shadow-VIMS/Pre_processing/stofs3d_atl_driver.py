...
from Source_sink.Relocate.relocate_source_feeder import relocate_sources
...
def main():
    ...
    hgrid_path = '/sciclone/schism10/feiye/STOFS3D-v8/I03a/hgrid.gr3'
...
def test():
    ...
    # inputs
    model_input_path = '/sciclone/schism10/feiye/STOFS3D-v7/Inputs/I12y/'
    config = ConfigStofs3dAtlantic.v7()
    hgrid = cread_schism_hgrid('/sciclone/schism10/feiye/STOFS3D-v7/Inputs/I12y/hgrid.gr3')
    # end inputs

    sub_dir = 'Source_sink'
    relocate_map = np.loadtxt(f'{model_input_path}/{sub_dir}/relocated_source_sink/relocate_map.txt', dtype=int)
    relocated_ss = relocate_sources(
        old_ss_dir=f'{model_input_path}/{sub_dir}/original_source_sink/',
