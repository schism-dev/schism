...
def main():
    ...
    hgrid_path = '/sciclone/schism10/feiye/STOFS3D-v8/I07d/hgrid.gr3'
    ...
    if input_files['elev_ic']:
        ...
        elev_ic = gen_elev_ic(
            ...
            base_elev_ic='/sciclone/schism10/feiye/STOFS3D-v7/Inputs/Iv7_Francine_update/Reinit_hot/elev0.gr3'
        )
