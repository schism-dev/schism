'''
This is the driver script to set up a SECOFS model.
'''
...
class Config_secofs():
    '''A class to handle the configuration of SECOFS model,
...
def main():
    ...
    config = Config_secofs.v1()
    config.rnday = 40
    config.startdate = datetime(2021, 8, 1)

    driver_print_prefix = '-----------------SECOFS driver:---------------------\n'
