!    Use this script if you do not explicitly list out the zcor of 
!    master grids (i.e. using S or other transformations).
...
!    ifort -cpp -DUSE_DOUBLE -O2 -mcmodel=medium -CB -Bstatic -o gen_vqs_1.WW ../UtilLib/schism_geometry.f90 gen_vqs_1.f90
