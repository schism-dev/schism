...
#-------------main starts-----------------
@sub_regions_sal = ('CB.reg','DB.reg', 'Harvey_init_sal.gr3.bnd.reg');
@sub_region_vals_sal=('1','2','2');  # '1': from obs; '2': from *.gr3 as specified below
@sub_grids_sal=('','DelawareBay_Data/DB_surf_S_ic.subset.gr3','Harvey_init_sal.gr3'); #corresponding to each sub_region
$full_grid_sal = 'sal_ic_reg.gr3'; #generated by auto.pl

@sub_regions_tem = ('CB.reg','Harvey_init_tem.gr3.bnd.reg');
@sub_region_vals_tem = ('1','2');
@sub_grids_tem=('','Harvey_init_tem.gr3'); #corresponding to each sub_region
$full_grid_tem = 'tem_ic_reg.gr3'; #generated by auto.pl

$script_dir="../Grid_manipulation/";
$hycom_dir="../HYCOM_HARVEY/";
