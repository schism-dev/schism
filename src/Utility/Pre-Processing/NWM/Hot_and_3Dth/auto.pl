...
#-------------main starts-----------------
@sub_regions_sal = ('CB.reg','DB.reg');
@sub_region_vals_sal=('1','2');  # '1': from obs; '2': from *.gr3 as specified below
@sub_grids_sal=('','DelawareBay_Data/DB_surf_S_ic.subset.gr3'); #corresponding to each sub_region
$full_grid_sal = 'sal_ic_reg.gr3'; #generated by auto.pl

@sub_regions_tem = ('CB.reg');
@sub_region_vals_tem = ('1');
@sub_grids_tem=(''); #corresponding to each sub_region
