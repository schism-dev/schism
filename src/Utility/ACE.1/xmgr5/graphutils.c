/* $Id: graphutils.c,v 1.3 2004/07/07 04:00:27 pturner Exp $
 *
...
void get_graph_velocityp(int gno, velocityp *v)
{
    memcpy(v, &g[gno].vp, sizeof(velocityp));
}
