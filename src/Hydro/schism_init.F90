...
!      time=0.d0
      ...
      !Other init that can be called from another driver program (e.g. ESMF, PDAF)
      call other_hot_init(iths)

!     Broadcast to global module and save
      iths_main=iths
...
!     Deallocate temp. arrays to release memory
      deallocate(nwild,nwild2,swild,swild2,swild3,swild10)
