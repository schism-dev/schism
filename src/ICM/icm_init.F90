...
!---------------------------------------------------------------------
  ...
  namelist /CORE/ GPM,TGP,KTGP,MTR,MTB,TMT,KTMT,FCP,FNP,FPP,FCM,FNM,FPM,  &
           ...
           & KPO4p,KPO4s,KPO4TSS,WRea,WDOs,PBmin,dz_flux,KSR0,TRSR,KTRSR,KhDOp
  ...
  elseif(imode==1) then
    ...
    o2n=0; dn2c=0; an2c=0; KhDO=0; KPO4p=0; KPO4s=0; KPO4TSS=0; WRea=0; WDOs=0; PBmin=0; dz_flux=0
...
!$OMP end parallel workshare
  ...
  pname(1:64)=(/'KeC    ','KeS    ','KeSalt ','Ke0    ','tss2c  ', &
  ...
  sp(m+1)%p1=>wqc0;  sp(m+2)%p=>WDOs;   sp(m+3)%p=>KPO4s;   sp(m+4)%p=>KPO4TSS; m=m+4
