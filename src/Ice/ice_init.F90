...
subroutine ice_init
 ...
 &delta_min,theta_io,mevp_alpha1,mevp_alpha2,mevp_cmax,mevp_cmin,mevp_slope,pstar,ellipse,c_pressure,niter_fct, &
 &ice_gamma_fct,h_ml0,salt_ice,salt_water,mevp_coef
  ...
  mevp_cmax=2.d3; mevp_cmin=2.d2; mevp_slope=2.d1
  ...
  if(mevp_cmin<=0.or.mevp_cmax<mevp_cmin) call parallel_abort('ice_init: mevp_cmax')
  if(mevp_slope<0.d0) call parallel_abort('ice_init: mevp_slope')
